...
class ExampleFormViewController: FormViewController {
    ...
    fileprivate func loadForm() {
        ...
        let section1 = FormSectionDescriptor(headerTitle: "Login data", footerTitle: nil)
        
        var row = FormRowDescriptor(tag: Static.emailTag, type: .label, title: "Email")
        row.configuration.cell.appearance = ["valueLabel.text" : "john@gmail.com" as AnyObject,
        "valueLabel.textAlignment" : NSTextAlignment.right.rawValue as AnyObject ]
        section1.rows.append(row)

        row = FormRowDescriptor(tag: Static.passwordTag, type: .password, title: "Password")
        row.configuration.cell.appearance = ["textField.placeholder" : "Enter password" as AnyObject,
                                             "textField.enabled": false as AnyObject,
                                             "textField.textAlignment" : NSTextAlignment.right.rawValue as AnyObject]
        section1.rows.append(row)
        
        let section2 = FormSectionDescriptor(headerTitle: "User information", footerTitle: nil)
        ...
        row.configuration.cell.appearance = [
            "titleLabel.font" : UIFont.preferredFont(forTextStyle: .title1),
                                             "segmentedControl.enabled": false as AnyObject,
